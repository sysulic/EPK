...
executable move(f1_0f,f2_0f) if  at_robot(f1_0f);
...
executable move(f1_2f,f2_2f) if  at_robot(f1_2f), open(f2_2f);
...
executable move(f2_1f,f2_0f) if  at_robot(f2_1f);
executable move(f2_1f,f2_2f) if  at_robot(f2_1f), open(f2_2f);
...
initially -lock_shape(f2_0f,shape0);
initially -lock_shape(f2_0f,shape1);
...
initially -open(f2_2f);
initially ( lock_shape(f0_2f,shape0) , -lock_shape(f0_2f,shape1) ) | ( lock_shape(f0_2f,shape1) , -lock_shape(f0_2f,shape0) );
initially ( lock_shape(f2_2f,shape0) , -lock_shape(f2_2f,shape1) ) | ( lock_shape(f2_2f,shape1) , -lock_shape(f2_2f,shape0) );
...
%% goal state ---------- 
goal  at(key0_0,f0_0f), at(key0_1,f0_1f), at(key1_0,f2_0f), at(key1_1,f2_2f);
