...
(:action sense_vis
 ...
 :precondition (at ?x ?z)
 :effect (and (visible_from ?t ?z) (true)))

(:action sense_rock
 :parameters (?x - rover ?t - objective ?z - waypoint )
 :precondition (at ?x ?z)
 :effect (and (at_rock_sample ?z) (true)))

(:action sense_soil
 :parameters (?x - rover ?t - objective ?z - waypoint )
 :precondition (at ?x ?z)
 :effect (and (at_soil_sample ?z) (true)))
...
(:action communicate_soil_data
 ...
 :effect ;(and (not (available ?r))
         ;     (not (channel_free ?l))
         ;     (channel_free ?l)
	  (and     (communicated_soil_data) (true) )
         ;     (available ?r)
	 ; )
)
